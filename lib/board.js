...
Board.prototype = {
  ...
  checkForMerge: function() {
    ...
    //see if there are any touching cells with the same value
    //if there is then a merge is possible, return true
    //double for loop?
    //replace this function with current way of checking for lost game
